...
if __name__ == "__main__":
    # PARAMETERS
    logfile_name = "test-5-lsmooth-gop_sentiment-lr10-6-1&1cw-a01.csv"
    train_file = '5_bert_train_corporate_messaging_mclass.csv'
    test_file = '5_bert_test_corporate_messaging_mclass.csv'
    num_labels = 3
    ...
    val_dataset = pd.read_csv(data_folder + test_file)
